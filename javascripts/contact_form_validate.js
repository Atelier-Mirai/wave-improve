...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"form_validate.js":[function(require,module,exports) {
/*=============================================================================
...
var validate = function validate() {
  var validForm = document.querySelector("form:valid"); // const submitButton = document.querySelector("#submit");
  // こちらも等価
...
validate(); // フォームに入力されたら、validate関数を実行
...
window.addEventListener('beforeunload', confirmation_aleat, false); // submit ボタンが押されたときには、離脱アラートを表示しない。
...
},{}]},{},["../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","form_validate.js"], null)
//# sourceMappingURL=/form_validate.js.map